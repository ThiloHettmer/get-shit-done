...
**See @~/.claude/get-shit-done/references/checkpoints.md** for detailed checkpoint patterns
...
**Use template from:** @~/.claude/get-shit-done/templates/summary.md#file-template
