---
name: gibd-phase-researcher
description: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by gibd-planner. Spawned by /gsd:plan-phase orchestrator.
...
<downstream_consumer>
Your RESEARCH.md is consumed by `gibd-planner`:
