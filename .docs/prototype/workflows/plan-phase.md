<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates gibd-phase-researcher, gibd-planner, and gibd-plan-checker agents with a revision loop (max 3 iterations).
</purpose>

<required_reading>
Read all files referenced by the invoking prompt's execution_context before starting.

@.docs/prototype/references/ui-brand.md
</required_reading>
...
```
Task(
  prompt="First, read .docs/prototype/agents/gibd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
```
Task(
  prompt="First, read .docs/prototype/agents/gibd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn gibd-plan-checker Agent
...
Task(
  ...
  subagent_type="gibd-plan-checker",
  model="{checker_model}",
...
- [ ] gibd-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] gibd-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] gibd-plan-checker spawned with CONTEXT.md
