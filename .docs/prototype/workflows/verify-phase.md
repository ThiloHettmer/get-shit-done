...
<required_reading>
@.docs/prototype/references/verification-patterns.md
@.docs/prototype/templates/verification-report.md
</required_reading>
...
See .docs/prototype/templates/verification-report.md for complete template.
</step>
